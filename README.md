...
Step by step instructions to set up, configure and running ATV on Windows is in the file: [step by step instructions] (https://github.com/AlfrescoLabs/technical-validation/blob/master/Step_by_step_instructions_to_run_on_windows)
